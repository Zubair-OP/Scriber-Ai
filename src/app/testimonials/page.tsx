...
const TESTIMONIALS: TestimonialCard[] = [
  {
    ...
    initials: "SJ",
    colorBg: "bg-secondary-container text-secondary",
    rating: 5
  },
  {
    ...
    initials: "MC",
    colorBg: "bg-primary-container/20 text-primary",
    rating: 5
  },
  {
    ...
    initials: "ER",
    colorBg: "bg-tertiary-container/30 text-tertiary",
    rating: 5
  },
  {
    ...
    <div className="min-h-screen flex flex-col bg-background text-on-surface">
      ...
      <main className="flex-grow py-20 px-4 md:px-10">
        <div className="max-w-[1200px] mx-auto text-center mb-16">
          <span className="inline-block px-3 py-1 mb-4 bg-secondary-container text-on-secondary-container font-label-sm text-label-sm rounded-full">
            Success Stories
          </span>
          ...
          {TESTIMONIALS.map((item, index) => (
            ...
            >
              <div>
                ...
                <p className="font-body-lg text-body-lg text-on-surface italic mb-8">
                  &quot;{item.quote}&quot;
                </p>
              </div>

              <div className="flex items-center gap-4 border-t border-surface-variant/50 pt-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg ${item.colorBg}`}>
                  {item.initials}
                </div>
                <div>
